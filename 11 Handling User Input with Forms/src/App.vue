    ...
    <form>
      ...
      <div class="row">
        <div
          class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3"
        >
          <!-- <app-switch v-model="switchValue"></app-switch> -->
          <app-switch
            :value="switchValue"
            @input="switchValue = $event"
          ></app-switch>
        </div>
      </div>
      <hr />
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <ul v-for="(mail, index) in sendMail" v-bind:key="index">
              <li>{{ mail }}</li>
            </ul>
            <p>Gender:{{ gender }}</p>
            <p>Priority:{{ prioritySelected }}</p>
            <p>Switched:{{ switchValue }}</p>
            <p v-if="isSubmitted">isSubmitted:{{ isSubmitted }}</p>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  watch: {
    userData: function (value) {
      console.log("🚀 ~ file: App.vue:131 ~ value", value);
    },
  },
};
</script>
